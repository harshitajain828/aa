...
const menuItems = [
  { href: '/water-saving-techniques', label: 'Water-Saving Techniques' },
  { href: '/case-studies', label: 'Case Studies' },
  { href: '/research-and-findings', label: 'Research and Findings' },
  { href: '/interactive-tools', label: 'Interactive Tools' },
  { href: '/community-forums', label: 'Community Forums' },
]
            ...
            <div className="flex-1">
              <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex-1 items-start md:grid md:grid-cols-[220px_minmax(0,1fr)] md:gap-6 lg:grid-cols-[240px_minmax(0,1fr)] lg:gap-10">
                <aside className="fixed top-14 z-30 -ml-2 hidden h-[calc(100vh-3.5rem)] w-full shrink-0 md:sticky md:block">
                  <nav className="h-full overflow-y-auto py-6 pr-6 lg:py-8">
